...
def main(entry):
    ...
    if name in ['m2_operator_directorate','m2_operator_nightcell']:
        bpy.context.scene.frame_set(1);bpy.context.view_layer.update()
        socket=bpy.data.objects.get('SOCKET_WEAPON')
        if socket:
            before=set(bpy.context.scene.objects)
            weapon='m2_smg' if name=='m2_operator_directorate' else 'm2_rifle'
    ...
    elif name in ['m2_rifle','m2_smg','m2_marksman','m2_carbine_fp']:
